...
def parallel_move():
    ...
    # initial position adjustment parameters
    z0rinc = 0.000
    z0linc = 0.004   
    ...
    # specify step interval in meter
    zrinc = 0.002
    zlinc = 0.002
    ...
    # for laser 600nm
    #right_point_x=0.657 + x0inc
    right_point_y=-0.170
    right_point_z=0.038 + z0rinc

    left_point_x=0.657
    left_point_y=0.0685
    left_point_z=0.038 + z0linc
    ...
    initial_xr=right_point_x 
    initial_xl=left_point_x
    ...
    for inter_z in range(zlooprange): 
        right_point_x=initial_xr
        left_point_x=initial_xl
        right_point_z=right_point_z-zrinc
        left_point_z=left_point_z-zlinc
        
        
        print ("z level: "+str(inter_z))

        for inter_x in range(xlooprange):
            right_point_x=right_point_x+xrinc
            left_point_x=left_point_x+xlinc
            ...
            print ("left_done: "+str(inter_x))
            
            # write joint parameter measurement into a file

            f=open('parallel_2d_test3.txt','a+')
            ...
            pause_time=6
            print ("All_done: "+str(inter_x)+' pause for '+str(pause_time))
...
# another way for intial angle
    ...
    #didnt use it
    distance_e=0.040
    # length of TIS camera
    distance_h=0.1
    # didnt use it
    distance_g=0.094
    #length of laser
    distance_l=0.150
    #distance from robot origin to nearest edge of phatom. 
    distance_i=0.7
...
#initial position5
    ...
    for inter in range(10):
        ...
        angleinc=1
        change_angle+=math.radians(angleinc)
