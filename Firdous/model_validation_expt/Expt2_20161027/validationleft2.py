...
#def move_arm_joint(limb_joints):
#    limb_left.move_to_joint_positions(limb_joints)
#    return 0
...
for inter in range(51):
    left_point_x = left_point_x + 0.002
    ...
    joint_angle_input = get_joint_angles('left',left_point_x,left_point_y,left_point_z,left_x_rotation,left_y_rotation,left_z_rotation,left_w_rotation)
    print('the joint angle input is ')
    print(joint_angle_input)

    limb_left = baxter_interface.Limb('left')
    limb_left.move_to_joint_positions(joint_angle_input)
    ...
    inputanglel   = str(joint_angle_input.values())
